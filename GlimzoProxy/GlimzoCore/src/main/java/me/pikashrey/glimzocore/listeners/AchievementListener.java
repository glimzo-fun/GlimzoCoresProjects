...
/**
 * Wires every in-game event to the AchievementManager trigger checks.
 * No achievement IDs are hardcoded here - everything is driven by achievements.yml.
 */
public class AchievementListener implements Listener {
    ...
    public void onJoin(PlayerJoinEvent event) {
        ...
        // Delay by 1 tick so data is guaranteed loaded
        org.bukkit.Bukkit.getScheduler().runTaskLater(plugin, () -> {
            am().checkLogin(uuid);
            // Pass 1 as streak - LOGIN_STREAK achievements with streak-days=1 fire every login
