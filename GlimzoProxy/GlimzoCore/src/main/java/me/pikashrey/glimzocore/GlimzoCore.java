...
public final class GlimzoCore extends JavaPlugin {
    ...
    // CosmeticUnlockManager is owned by CosmeticManager - accessed via getCosmeticManager().getUnlockManager()
    ...
    public void onEnable() {
        ...
        // tablistManager initialized in initManagers()
    ...
    public void onDisable() {
        ...
        // Restore staff mode players' inventories before shutdown
        ...
        // Flush all online player data synchronously before MySQL disconnects
        me.pikashrey.glimzocore.api.player.GlobalPlayer.saveAll();

        // Synchronously save cosmetic state for all online players.
    ...
    private void initManagers() {
        ...
        // cosmeticUnlockManager is created inside CosmeticManager.enable() - no separate instantiation needed
        ...
        // Start cross-network rank sync once everything is wired
    ...
    private void registerCommands() {
        me.pikashrey.glimzocore.commands.api.manager.CommandHandler h =
                new me.pikashrey.glimzocore.commands.api.manager.CommandHandler(this, null) {};
    ...
    private void startTasks() {
        ...
        // Nametag refresh - main thread, every 100 ticks (5s)
        Bukkit.getScheduler().runTaskTimer(this,
                new me.pikashrey.glimzocore.nametags.update.NameTagThread(this), 100L, 100L);
        // Prune old social_events and rank_logs rows every 6 hours
    ...
    public me.pikashrey.glimzocore.features.cosmetics.CosmeticUnlockManager getCosmeticUnlockManager() { return cosmeticManager != null ? cosmeticManager.getUnlockManager() : null; }
