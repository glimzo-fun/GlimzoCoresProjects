...
public class ClanCreateEvent extends GlimzoEvent {

    private static final HandlerList HANDLERS = new HandlerList();

    private final PlayerData playerData;  // the founder
    private final ClanData   clanData;

    public ClanCreateEvent(PlayerData playerData, ClanData clanData) {
