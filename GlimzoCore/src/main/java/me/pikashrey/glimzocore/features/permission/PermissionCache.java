...
public class PermissionCache {
    ...
    public Set<String> getPlayer(UUID uuid)                 { return playerCache.get(uuid); }
    public void invalidatePlayer(UUID uuid)                 { playerCache.remove(uuid); }
    ...
    public void clearRanks() { rankCache.clear(); }
    public void clearAll()   { playerCache.clear(); rankCache.clear(); }
}
