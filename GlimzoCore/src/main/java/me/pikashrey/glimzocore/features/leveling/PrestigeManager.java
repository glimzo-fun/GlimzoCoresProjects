...
public class PrestigeManager {
    ...
    public boolean prestige(UUID uuid) {
        ...
        if (data == null || data.getLevel() < LevelManager.MAX_LEVEL) return false;
        ...
        plugin.getGemManager().addGems(uuid, base + scaling * data.getPrestige(), "Prestige " + data.getPrestige() + " reward");
    ...
    public String getPrestigeDisplay(int prestige) {
        ...
        org.bukkit.configuration.file.FileConfiguration cfg = plugin.getConfigManager().getLeveling();
